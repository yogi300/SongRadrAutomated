...
public class SocketClient extends Client
{
    ...
    protected JSONObject call(String cmd, JSONObject args)
            throws IOException, com.DeathByCaptcha.Exception, AccessDeniedException, InvalidCaptchaException, ServiceOverloadException {
        try {
            args.put("cmd", cmd).put("version", API_VERSION);
    ...
    public Captcha upload(int type, JSONObject json)
        ...
        JSONObject args = new JSONObject();
        try {
            args.put("swid", SOFTWARE_VENDOR_ID).put(
                "type", Integer.toString(type)).put(
                "token_params", json);
